...
},{}],"charming.min.js":[function(require,module,exports) {
!function (e) {
...
(function () {
  ...
  var path = anime.path("#motionPath path"); //   var motionPath = anime({
  ...
  var charming = require("./charming.min.js");

  charming(document.body.querySelector(".title"), {
    classPrefix: 'letter'
  });
  var anim = anime((_anime = {
    targets: ".title span",
    easing: "easeInOutSine",
    duration: 1000,
    direction: "alternate",
  ...
  }, _defineProperty(_anime, "direction", "alternate"), _defineProperty(_anime, "loop", true), _defineProperty(_anime, "translateY", function translateY(el, index) {
    return index % 2 === 0 ? ['-80%', '0%'] : ['80%', '0%'];
  }), _defineProperty(_anime, "rotateZ", [90, 0]), _defineProperty(_anime, "rotate", function rotate(el, index) {
    var val = index * 7 + 6 + "deg";
    return [val, val];
  }), _defineProperty(_anime, "opacity", 1), _anime));
})();
},{"./anime.min.js":"anime.min.js","./charming.min.js":"charming.min.js"}],"C:/Users/JLou/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/JLou/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main.js"], null)
